...
class StockMoveLine(models.Model):
    ...
    def as_barcode_2(self):
        ...
        if self.lot_id.expiration_date:
            fecha_vencimiento = self.lot_id.expiration_date.strftime('%d%m%Y')
        codigo = '(37)'+str(self.product_id.as_cantidad_unidades)+'(3101)'+str(self.qty_done)+'(15)'+str(fecha_vencimiento)
        return codigo
